            ...
            fields: [
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow DataSaga AI to index everything in the shared drives you have access to."
                    : "This will allow DataSaga AI to index everything in your Organization's shared drives.";
                },
              ...
              },
              {
                ...
                description: (currentCredential) => {
                  return currentCredential?.credential_json?.google_tokens
                    ? "This will allow DataSaga AI to index everything in your My Drive."
                    : "This will allow DataSaga AI to index everything in everyone's My Drives.";
                },
              ...
              },
              {
                type: "checkbox",
                description:
                  "This will allow DataSaga AI to index all files shared with you.",
            ...
            fields: [
              {
                ...
                optional: true,
                description:
                  "Specify the Salesforce object types you want us to index. If unsure, don't specify any objects and DataSaga AI will default to indexing by 'Account'." +
            ...
            fields: [
              {
                ...
                description:
                  ...
                  "\n  }" +
                  "\n}" +
                  "\n\n[See our docs](https://docs.datasaga.ai/connectors/salesforce) for more details.",
              },
            ],
          },
        ],
...
• Specifying 'https://datasagaai.sharepoint.com/sites/support' for example only indexes this site.
• Specifying 'https://datasagaai.sharepoint.com/sites/support/subfolder' for example only indexes this folder.
`,
      },
    ],
    advanced_values: [
    ...
    values: [
      {
        ...
        name: "teams",
        optional: true,
        description: `Specify 0 or more Teams to index. For example, specifying the Team 'Support' for the 'datasagaai' Org will cause us to only index messages sent in channels belonging to the 'Support' Team. If no Teams are specified, all Teams in your organization will be indexed.`,
      },
    ],
    advanced_values: [],
  },
    ...
    values: [
      {
        ...
        name: "base_url",
        optional: false,
        description: `Specify the base URL for your Slab team. This will look something like: https://datasaga.slab.com/`,
      },
    ],
    advanced_values: [],
  },
